...
// UpdateOptions represents the options for updating a organisation.
...
// Update handler update a new organisation.
...
func (h *UpdateHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	organisation, err := h.service.Update(r.Context(), id, &service.UpdateOptions{
		Title: options.Title,
	})
	if err != nil {
		write(w, http.StatusBadRequest, &Response{
			Message: "Failed to update the organisation.",
			Err:     err,
		})
		return
	}
	...
	write(w, http.StatusOK, &Response{
		Message: "The organisation was updated successfully.",
		Data:    organisation,
	})
	return
}
