...
// CreateOptions represents the options for creating a organisation.
...
func (o *CreateOptions) preset(ctx context.Context) error {
	...
	o.OwnerID = claims.XUserID
	return nil
}

// Create handler create a new organisation.
...
func (h *CreateHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	organisation, err := h.service.Create(ctx, &service.CreateOptions{
		Title:   options.Title,
		OwnerID: options.OwnerID,
	})
	if err != nil {
		write(w, http.StatusBadRequest, Response{
			Message: "Failed to create the organisation.",
			Err:     err,
		})
		return
	}
	...
	write(w, http.StatusCreated, Response{
		Message: "The organisation was created successfully.",
		Data:    organisation,
	})
}
