...
type Base struct {
	...
	// Generally, used for soft deletes (marking organisations as deleted without actually removing them from the database).
	//
	// Example: "2021-07-01T12:00:00Z"
...
// This function is called by gorm before creating a organisation.
//
// It performs the following operations:
//
// - Generates a new UUID for the organisation.
